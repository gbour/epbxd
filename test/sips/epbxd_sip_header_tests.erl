...
headers_test_() ->
	{setup, local,
		...
		fun(_) ->
			[
				 {"'From' header"           , test_from_header()}
				,{"'To' header"             , test_to_header()}
				,{"'Contact' header"        , test_contact_header()}
				,{"'Content-Length' header" , test_content_length_header()}
				,{"'CSeq' header"           , test_cseq_header()}
				,{"'Max-Forwards' header"   , test_max_forwards_header()}
				,{"'Via' header"            , test_via_header()}
				,{"'Custom' header"         , test_custom_header()}
			]
		end
	}.
